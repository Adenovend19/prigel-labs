...
export default function Features() {
  return (
    <section className="py-xxl px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto overflow-hidden">
      ...
      >
        <span className="font-label-md text-primary-fixed tracking-[0.3em] uppercase">Keunggulan</span>
        <h2 className="font-headline-lg text-headline-lg text-primary mt-sm">Kenapa Prigel Labs Limited?</h2>
      </motion.div>
      <motion.div 
        initial="hidden"
        whileInView="visible"
